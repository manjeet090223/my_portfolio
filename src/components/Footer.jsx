...
import { FaLinkedinIn, FaGithub, FaCode } from "react-icons/fa"; // react-icons
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 text-center py-10 relative">
      <h2 className="text-2xl font-bold text-gray-600">Brandon Johnson</h2>
      ...
      <p className="text-gray-500 text-sm">
        Copyright <strong className="text-gray-600">Alex Smith</strong> All Rights Reserved
        <br />
        Designed by{" "}
        <a href="https://bootstrapmade.com/" className="text-[#0563bb] hover:underline">
          BootstrapMade
        </a>{" "}
        Distributed by{" "}
        <a href="https://themewagon.com/" className="text-[#0563bb] hover:underline">
          ThemeWagon
        </a>
      </p>
